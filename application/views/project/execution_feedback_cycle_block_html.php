<div class="side-block-container feedback-cycle-block-container">
    <div class="sb-head">
        <h6><span class="sb-head-icon"><img src="<?php echo $this->config->item("site_url");?>assets/images/arrange-icon-white.svg" alt=""></span>Feedback Cycle</h6>
