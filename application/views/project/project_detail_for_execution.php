<!doctype html>
    ...
    <head>
        ...
        <style>
            .input-daterange:before {display:none;}
        </style>       
    </head>
    <body>
        <!-- ======================== Topbar start ========================== -->
                    ...
                    <div class="cpanel-left d-flex">
                        ...
                        <div class="cpanel-body">
                            <ul class="cpanel-options d-flex align-items-center">
                                ...
                                <li class="no-link">
                                    <a href="#"><img src="<?php echo $this->config->item("site_url");?>assets/images/dots-icon.svg" alt="" /></a>
        ...
        <?php $this->load->view('inc/js/project-execution-js');?>        
  </body>
</html>