<div class="side-block-container milestone-block-container">
    <div class="sb-head">
        <h6><span class="sb-head-icon"><img src="<?php echo $this->config->item("site_url");?>assets/images/flag-icon-white.svg" alt=""></span>Milestone</h6>
                ...
                <div class="phase-form-container">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-daterange-1 from-to-date-picker-div">
                                ...
                                <div class="text-box execution-text-box to-text-date-picker"><?php echo $this->general->display_date_format_in_input($block_data[0]->end_date); ?></div>
                            </div>
                        </div>
