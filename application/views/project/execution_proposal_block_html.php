<div class="side-block-container proposal-block-container">
    <div class="sb-head">
        <h6><span class="sb-head-icon"><img src="<?php echo $this->config->item("site_url");?>assets/images/proposal-icon-white.svg" alt=""></span>Proposal</h6>
            ...
            <div class="pahse-sb-upper">
                <div class="phase-form-container">
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-box execution-text-box"><?php echo $block_data[0]->contact_person; ?></div>
                        </div>
                ...
                <div class="pahse-sb-lower">
                    ...
                    <?php for($i=0;$i<count($active_task_list_arr);$i++){ ?>
                        <div class="task-card">
                            ...
                            <div class="task-btn btn-block task_mark_complete_html">
