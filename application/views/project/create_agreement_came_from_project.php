    ...
    <div class="modal-body d-flex justify-content-center flex-column align-items-center text-center">
        <div class="full-width">
            ...
            <div class="form-group form-button d-flex justify-content-between">
                ...
                <input type="button" name="submit" id="create_agreement_btn" class="btn btn-primary" value="Done" onclick="funAjaxPostCreateAgreement(this.form)" >
                <button type="button" id="wait_create_agreement_btn" class="btn btn-primary display-hide ml-0"><b class="btn-loader"><img src="<?php echo $this->config->item("site_url");?>assets/images/loader.svg" alt="loader" class="loader-img fa-spin" style="height: 15px;" /></b>Done</button>
            </div>
        </div>            
    </div>
</form>