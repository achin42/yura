<form name="frm_update_phase" id="frm_update_phase" action="<?php echo $this->config->item("site_url");?>project/fn_update_phase" method="post" data-toggle="validator" novalidate="true" enctype="multipart/form-data">
    ...
    <div class="modal-body d-flex justify-content-center flex-column align-items-center text-center">
        <div class="full-width">
            <div class="form-group client-input">
                ...
                <input type="text" name="phase_name" id="phase_name" class="form-control" required="required" data-required-error="Phase Name cannot be blank." value="<?php echo $phase_data[0]->phase_name; ?>" >
            ...
            <div class="form-group form-button d-flex justify-content-end" style="margin-bottom: 0;">
                <input type="button" name="submit" id="update_phase_btn" class="btn btn-primary" value="Update Phase" onclick="funAjaxPostUpdatePhase(this.form,'<?php echo $project_sk;?>','<?php echo $phase_sk;?>')" >
                <button type="button" id="wait_update_phase_btn" class="btn btn-primary display-hide ml-0"><b class="btn-loader"><img src="<?php echo $this->config->item("site_url");?>assets/images/loader.svg" alt="loader" class="loader-img fa-spin" style="height: 15px;" /></b>Update Phase</button>
            </div>
        </div>            
    </div>
</form>