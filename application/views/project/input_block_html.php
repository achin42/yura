<div class="side-block-container input-block-container">
    <div class="sb-head">
        <h6><span class="sb-head-icon"><img src="<?php echo $this->config->item("site_url");?>assets/images/multiple-input-icon-white.svg" alt=""></span>Input</h6>
                ...
                <div class="phase-form-container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-daterange-1 from-to-date-picker-div">
                            <input type="text" class="form-control from-date-picker" name="start_date" id="block_start_date" required="required" data-required-error="Start Date Range cannot be blank." value="<?php echo $this->general->display_date_format_in_input($block_data[0]->start_date); ?>">
                            <div class="to-text-date-picker">to</div>
                            <input type="text" class="form-control to-date-picker" name="end_date" id="block_end_date" required="required" data-required-error="End Date Range cannot be blank." value="<?php echo $this->general->display_date_format_in_input($block_data[0]->end_date); ?>">                            
                        </div>
                        <span class="help-block with-errors"></span>                        
                    </div>
                    <!--div class="form-group">
