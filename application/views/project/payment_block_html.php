<div class="side-block-container payment-block-container">
    ...
    <div class="sb-body phase-sb-body">
        <form name="frm_update_block" id="frm_update_block" action="<?php echo $this->config->item("site_url");?>project/fn_update_block" method="post" data-toggle="validator" novalidate="true" enctype="multipart/form-data">
            ...
            <input type="hidden" name="payment_currency" id="payment_currency" class="form-control" value="USD" >
                ...
                <div class="phase-form-container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative" style="padding-right: 100px;">                                
                            <input type="number" name="payment_amount" id="payment_amount" step="any" min="1" required="required" data-required-error="Amount cannot be blank." <?php if($block_data[0]->payment_amount > 0){ ?>value="<?php echo $block_data[0]->payment_amount; ?>"<?php } ?> class="form-control" style="padding-right: 30px;"  />
                    ...
                    <div class="form-group">
                        <label for="select-input">Split of Platform Fees</label>
                        <div class="select-input">
                            <select class="form-control input-md">
                                <option>Agency only</option>
                                <option>Client only</option>
                                <option>Both agency and client</option>
                            </select>
                        </div>
                    </div>                    
                    <!--div class="form-group">
                ...
                <div class="pahse-sb-lower">
                    ...
                    <?php $i = 0; foreach($q_task_data as $task_data){ ?>
                        ...
                        <div class="task-card">
                            ...
                            <?php if($task_data->action_name == 'pay_now' && $task_data->payment_action == '1'){ ?>
                                <?php if($block_data[0]->payment_amount != '' && $block_data[0]->payment_amount > '0'){ ?>    
                                    <div class="card-text">
                                        Pay $<?php echo number_format($block_data[0]->payment_amount,2);?> for the Phase <?php if($phase_rows > 0){ ?>'<?php echo $q_phase_data[0]->phase_name;?>'<?php } ?> by <?php echo $this->general->display_date_format_front($block_data[0]->end_date);?>
                                    </div>
                                <?php }else{ ?>
