<!doctype html>
    ...
    <body>
                        ...
                        <div class="col-sm-12">
                            <div class="payment-mode-box">
                                ...
                                <div class="new-card-container">
                                    <form name="frm_agency_company_detail" id="frm_agency_company_detail" action="<?php echo $this->config->item("site_url");?>user/fn_update_agency_company_detail" method="post" data-toggle="validator" novalidate="true" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="verify_company" id="verify_company" value="no">
                                        <input type="hidden" name="old_company_name" id="old_company_name" value="<?php echo $company_data[0]->company_name;?>">
                                        <input type="hidden" name="old_country_code" id="old_country_code" value="<?php echo $company_data[0]->country_code;?>">
                                        <input type="hidden" name="old_country_name" id="old_country_name" value="<?php echo $company_data[0]->country_name;?>">
                                        ...
                                        <div class="new-form-container">
                                            ...
                                            <div class="varify-btn form-group form-button remove-bottom-margin">
                                                <input type="button" name="submit" id="btn_verify_agency_company_detail" class="btn btn-default display-hide" value="VERIFY" onclick="funAjaxPostVerifyAgencyCompanyDetail(this.form)">
                                                <button type="button" id="wait_btn_verify_agency_company_detail" class="btn btn-default display-hide ml-0"><b class="btn-loader"><img src="<?php echo $this->config->item("site_url");?>assets/images/loader.svg" alt="loader" class="loader-img fa-spin" style="height: 15px;" /></b> VERIFY</button>
                                                <input type="button" name="submit" id="btn_agency_company_detail" class="btn btn-default display-hide remove-left-margin" value="Save Changes" onclick="funAjaxPostAgencyCompanyDetail(this.form)">                                                
                                                <button type="button" id="wait_btn_agency_company_detail" class="btn btn-default display-hide ml-0"><b class="btn-loader"><img src="<?php echo $this->config->item("site_url");?>assets/images/loader.svg" alt="loader" class="loader-img fa-spin" style="height: 15px;" /></b> Save Changes</button>
                                            </div>
                                        </div>
                                            ...
                                            <?php if($logged_in_is_agency_verified == '0'){ ?>
                                                ...
                                                <?php if($logged_in_applied_for_manual_verification == '1'){ ?>
                                                    <div class="new-varify-box profile-pending d-flex align-items-center justify-content-between">
                                                        ...
                                                        <!-- <div class="nv-btn"><a href="#!" class="btn btn-primary">VERIFY NOW</a></div> -->
                                                    </div>
                                                <?php } ?> 
        ...
        <?php $this->load->view('inc/js/agency-company-detail-js');?>
