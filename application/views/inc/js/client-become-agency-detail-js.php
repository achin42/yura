...
jQuery(document).ready(function($){
    ...
    $('#frm_client_become_agency_company_detail').keypress(function(e) {
        var key = e.which;
        if (key == 13) {
            var client_become_agency_company_detail_obj = document.getElementById("frm_client_become_agency_company_detail");
            funAjaxPostClientBecomeAgencyCompanyDetail(client_become_agency_company_detail_obj);
            return false;
        }
    });
...
function funAjaxPostClientBecomeAgencyCompanyDetail(obj){
	jQuery('#btn_client_become_agency_company_detail').hide();
	jQuery('#wait_btn_client_become_agency_company_detail').show();
    ...
    //popError = false;
	if(popError === true){
		jQuery('#btn_client_become_agency_company_detail').show();
        jQuery('#wait_btn_client_become_agency_company_detail').hide();
		return false;
	}  else {
        			...
        			if(arrTotal[0] == 'company_exists'){
                		...
                		$.ajax({
                			...
                			success:function(data){
                				...
                				if(arrTotal[1] == '1'){
                                    ...
                                    $("#apply_for_manual_verification").on("click",function(){
                                        ...
                                        var apply_for_manual_verification_obj = document.getElementById("frm_client_become_agency_company_detail");
                			...
                			error:function(jqXHR, exception){
                                ...
                                if(err_msg != ''){
                                    fn_send_ajax_error_handling_mail(jqXHR.status, jqXHR.responseText, exception, err_msg, 'funAjaxPostClientBecomeAgencyCompanyDetail');        
                                }
                                return false;
                			}
                		});        			 
