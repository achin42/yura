<!doctype html>
    ...
    <body class="member-page">
                    ...
                    <div class="form-container">
                        ...
                        <div class="signin-form onboard-form">
                            <div class="signin-form-outer">
                                <h2>Delete User</h2>
                                <form name="frm_delete_user" id="frm_delete_user" action="<?php echo $this->config->item("site_url");?>login/fn_delete_users_instance" method="post" data-toggle="validator" novalidate="true">
                                    <div class="form-group">
                                        <label for="email"><strong>Email</strong></label>
                                        <div class="input-group">                                  
                                            <input type="email" pattern=".*@\w{1,}\.\w{2,}" name="delete_email" id="delete_email" class="form-control with-icon" required data-required-error="Please enter email." data-error="Please enter email." placeholder="Type email id and press enter">                                            
        ...
        <?php $this->load->view('inc/js/deleteuser-js');?>
    </body>
</html>