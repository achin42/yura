                ...
                <div class="new-company-detail-box">
                    ...
                    <div class="ncd-body">
                        <div class="new-card-container px-0 py-0 signup-profile-form">
                            <form name="frm_invited_signup_step_2" id="frm_invited_signup_step_2" action="<?php echo $this->config->item("site_url");?>login/fn_invited_signup_step_2" method="post" data-toggle="validator" novalidate="true">
                                <input type="hidden" name="invited_users_sk" id="invited_users_sk" value="<?php echo $users_sk;?>" />
                                <input type="hidden" name="invited_email" id="invited_email" value="<?php echo $user_email;?>" />
                                <p>How do you want to use this platform?</p>
                                <div class="form-group">
                                    <label class="has-radio">As a <b> Client </b>
                                        <input type="radio" name="user_type" value="client" <?php if($user_type == 'client'){ ?>checked="checked"<?php } ?> >
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="form-group mb-0">
                                    <label class="has-radio">As both <b> Agency </b> and  <b> Client </b>
                                        <input type="radio" name="user_type" value="both" <?php if($user_type == 'both'){ ?>checked="checked"<?php } ?> >
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group" id="agency_div" <?php if($user_type == 'agency'){ ?><?php }else{ ?>style="display:none;"<?php } ?> >
                                ...
                                <div class="form-group" id="client_div" <?php if($user_type == 'client'){ ?><?php }else{ ?>style="display:none;"<?php } ?> >
                                ...
                                <div class="form-group" id="both_div" <?php if($user_type == 'both'){ ?><?php }else{ ?>style="display:none;"<?php } ?> >
                                ...
                                <div class="form-group form-button">
                                    <input type="button" name="submit" id="btn_invited_signup_step_2" class="btn btn-default" value="NEXT" onclick="funAjaxPostInvitedStep2(this.form)">
                                    <button type="button" id="wait_btn_invited_signup_step_2" class="btn btn-default display-hide ml-0"><b class="btn-loader"><img src="<?php echo $this->config->item("site_url");?>assets/images/loader.svg" alt="loader" class="loader-img fa-spin" style="height: 15px;" /></b> NEXT</button>
                                </div>
                            </form>
                        </div>
                    </div>
