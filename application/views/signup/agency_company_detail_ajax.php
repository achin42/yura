                ...
                <div class="new-company-detail-box">
                    ...
                    <div class="ncd-body">
                        <div class="new-card-container px-0 py-0">
                            <form name="frm_new_signup_step_5" id="frm_new_signup_step_5" action="<?php echo $this->config->item("site_url");?>login/fn_insert_new_signup_step_5" method="post" data-toggle="validator" novalidate="true" enctype="multipart/form-data" >
                                ...
                                <div class="new-form-container">
                                    ...
                                    <div class="varify-btn d-flex align-items-center justify-content-between">
                                        <div class="varify-left d-flex align-items-center justify-content-between">
                                            <input type="button" name="submit" id="btn_signup_step_5" class="btn btn-default" value="VERIFY" onclick="funAjaxPostNewSignUpStep5(this.form)">
                                            <button type="button" id="wait_btn_signup_step_5" class="btn btn-default display-hide ml-0"><b class="btn-loader"><img src="<?php echo $this->config->item("site_url");?>assets/images/loader.svg" alt="loader" class="loader-img fa-spin" style="height: 15px;" /></b> VERIFY</button>
                                            <input type="button" name="submit" id="btn_signup_step_5_verify_later" class="btn no-shadow link-btn verify_later_loader_button ml-0" value="I'll verify later" onclick="funAjaxPostNewSignUpStep5VerifyLater(this.form)">
                                            <button type="button" id="wait_btn_signup_step_5_verify_later" class="btn no-shadow link-btn verify_later_loader_button display-hide ml-0"><b class="btn-loader"><img src="<?php echo $this->config->item("site_url");?>assets/images/loader.svg" alt="loader" class="loader-img fa-spin" style="height: 15px;" /></b> I'll verify later</button>                                            
                                        </div>
