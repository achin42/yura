...
class Ajax_pagination{
    ...
    var $next_link       = '<i class="la la-angle-right"></i>';
    var $prev_link       = '<i class="la la-angle-left"></i>';
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '';
    var $full_tag_close  = '';
    ...
    var $last_tag_open   = '';
    var $last_tag_close  = '';
    var $cur_tag_open    = '<li class="paginate_button page-item active"><span class="page-link">';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
			$info = '<div class="col-md-5 col-sm-12"><div class="dataTables_info" id="sample_1_info" role="status" aria-live="polite">';
            //$info .= 'Showing ' . $this->total_rows;
			$info .= "Showing ".($this->total_rows)." of ". $this->total_rows." total results"; 
			$info .= '</div></div>';
            return $info;
        }
        ...
        if ($this->show_count){
			...
			$info = '<div class="col-md-5 col-sm-12"><div class="dataTables_info" id="kt_table_1_info" role="status" aria-live="polite">';
            ...
            $info .= ' of ' . $this->total_rows." total results";
			$info .= '</div></div>';
            $output .= $info;
        }
		$output .= '<div class="col-md-6 col-sm-12 dataTables_pager"><div class="dataTables_paginate paging_simple_numbers" id="kt_table_1_paginate"><ul class="pagination" style="visibility: visible;">';
    ...
    function getAJAXlink($count, $text) {
        ...
        return '<li class="paginate_button page-item next"><a href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'('.$pageCount.')">'. $text .'</a></li>';
    }
}
?>